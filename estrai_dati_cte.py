...
def estrai_dati_offerta_cte(testo: str) -> dict:
    try:
        prompt = (
            ...
            "- spread (considera il prezzo della materia energia sia essa energia elettrica o gas solo se tariffa Variabile, es. 0.0135) oppure null\n"
            "- costo_fisso (se l'importo è maggiore di 30 euro dividilo per 12 e mostra il risultato)\n"
